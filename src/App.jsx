...
export default function App(){
 ...
 const header=<header><div className="brand"><div className="logo"><Leaf/></div><div><b>SG CARBON 2050</b><small>Singapore Transition Simulator</small></div></div><div className="team">{team}</div><button className="reset" onClick={reset}><RotateCcw size={16}/> Restart</button></header>;
